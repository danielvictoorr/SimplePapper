...
<head>
    ...
    <!--  -->
    <link rel="stylesheet" href="application/views/Inicial/css/style.css">
</head>
<body>
    <!-- barra de barra_navegacao -->
    <nav class="navbar navbar-expand navbar-dark color-primary" aria-label="Second navbar example">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><img src="/system/Image/SP.png" width="35" height="35" alt="">   SimplePaper</a>
      ...
      <div class="container px-4 py-5" id="eventos">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
          <div class="feature col" id="ev-1">
            <img src="/system/Image/sm-computacao.png" width="350" height="80" alt="">
          ...
          <div class="feature col" id="ev-2">
            <img src="/system/Image/c&t.png" width="350" height="80" alt="">
            <h2>Semana C&T</h2>
